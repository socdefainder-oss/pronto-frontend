            ...
            <div className="relative mt-2 space-y-2">
              ...
              {restaurantSlug && (
                <a
                  ...
                  className="block w-full px-3 py-2 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg hover:border-blue-300 hover:from-blue-100 hover:to-indigo-100 transition-colors"
                >
