...
export default function ReportsPage({ params }: { params: { id: string } }) {
  ...
  // Fun├º├úo para formatar hora (0-23 para "00:00")
  const formatHour = (hour: number) => {
    return `${hour.toString().padStart(2, '0')}:00`;
  };

  // Fun├º├úo para formatar data curta (dd/mm)
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900 flex items-center gap-3">
                  ...
                  Relat├│rios e An├ílises
                </h1>
                <p className="text-sm text-gray-500 mt-1">Visualize o desempenho do seu neg├│cio</p>
              </div>
            </div>
          ...
          <div className="border-t-2 border-gray-200 pt-4">
            <div className="flex flex-wrap gap-2">
              {[
                ...
                { key: "cardapio", label: "Card├ípio" },
                { key: "historico", label: "Hist├│rico de pedidos" },
                { key: "produtos", label: "Produtos" },
                { key: "feedbacks", label: "Feedbacks" },
                { key: "qualidade", label: "N├¡vel de qualidade" },
              ].map((tab) => (
                <Link
                  key={tab.key}
            ...
            <div className="space-y-6">
              ...
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                <div className="bg-white rounded-xl shadow-lg border-2 border-gray-200 p-5">
                  ...
                  <div className="text-sm text-gray-600 mb-1">Pedidos Entregues no Per├¡odo</div>
                ...
                <div className="bg-white rounded-xl shadow-lg border-2 border-gray-200 p-5">
                  ...
                  <div className="text-sm text-gray-600 mb-1">Pedidos Recebidos no Per├¡odo</div>
                  <div className="text-2xl font-bold text-gray-900">{stats?.totalOrders || 0}</div>
                </div>
              </div>

              {/* Cards de M├®tricas Secund├írias */}
        ...
        {activeTab !== "resumo" && (
          <div className="bg-white rounded-2xl shadow-xl border-2 border-gray-200 p-12">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Relat├│rio em desenvolvimento</h3>
              <p className="text-gray-600">Esta se├º├úo estar├í dispon├¡vel em breve.</p>
            </div>
          </div>
        )}
      </div>
